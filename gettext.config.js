...
module.exports = {
  input: {
    path: "./arches_customizable_reports/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_customizable_reports/locale", // output path of all created files
