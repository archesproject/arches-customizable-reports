"""
Django settings for arches_customizable_reports project.
"""
...
APP_NAME = 'arches_customizable_reports'
...
DATATYPE_LOCATIONS.append('arches_customizable_reports.datatypes')
FUNCTION_LOCATIONS.append('arches_customizable_reports.functions')
ETL_MODULE_LOCATIONS.append('arches_customizable_reports.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('arches_customizable_reports.search_components')
...
SECRET_KEY = 'django-insecure-l*1z1eu=*-38c-=^pf9v!rf!0ld_r!o@_ckzq)e9+o%f+l=kyb'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_customizable_reports.urls"
ROOT_HOSTCONF = "arches_customizable_reports.hosts"

DEFAULT_HOST = "arches_customizable_reports"
...
ELASTICSEARCH_PREFIX = 'arches_customizable_reports'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_customizable_reports.search_indexes.sample_index.SampleIndex',
...
DATABASES = {
    "default": {
        ...
        "HOST": "localhost",
        "NAME": "arches_customizable_reports",
        "OPTIONS": {
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_customizable_reports",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = 'arches_customizable_reports.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_customizable_reports'
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_customizable_reports.search.es_mapping_modifier.EsMappingModifier"]
